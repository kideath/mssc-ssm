...
public class StateMachineConfig extends StateMachineConfigurerAdapter<PaymentState, PaymentEvent> {
    ...
    private final Action<PaymentState, PaymentEvent> preAuthAction; // Spring will authiwire with the same name class
...
//    }
    ...
    public Action<PaymentState, PaymentEvent> authorizeAction() {
        return context -> {
            System.out.println("authorizeAction was called!!!");
            ...
            if (new Random().nextInt(10) < 8) {
                ...
                System.out.println("Auth Error! Something went wrong!!!");
